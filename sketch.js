...
function aa() {
  ...
  flower = new Flower(200, 500, 163, 204, 0.5);
  ma.display();
  a2 = new Flower(363, 320, 199, 14, 0.5);
  a2.dis();
  cute.display();
  flower.display();
  a1 = new Flower(100, 450, 120, 79, 0.5);
  a3 =new Flower(1051,457,30,120,0.5);
  a4 = new Flower(1235,688,124,94,0.5);
  a5 = new Flower(1403,1100,35,194,1);
  a1.dis();
  a3.dis();
  a4.dis();
  a5.dis();

  if (a<=13| millis()>17000){
  xpos = 235 - 30 * t
  t = t + 0.02
  ypos = 16 + 25 * a
  a = a + 0.02
  }
  if (t > 5.1 / 1.015&&t<=13| millis()>17000) {
    xpos = 235 - 30 * t + 45 * b
    b = b + 0.02
...
function  bb() {
  ...
  flower = new Flower(xpos*2+300,ypos*2+50,163, 204, 0.5)
  flower.dis1()
